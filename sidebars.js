...
module.exports = {
  ...
  androidSidebar: [
    ...
    {
      type: 'doc',
      id: 'sdk/android/pay_theory_fragment',
    },
    {
      type: 'doc',
      id: 'sdk/android/merchant_activity_and_payable',
    },
    {
      type: 'category',
      label: 'Functions',
      items: [
        {
          type: 'doc',
          id: 'sdk/android/functions/configure_payment',
        },
        {
          type: 'doc',
          id: 'sdk/android/functions/transact',
        },
        {
          type: 'doc',
          id: 'sdk/android/functions/configure_tokenize',
        },
        {
          type: 'doc',
          id: 'sdk/android/functions/tokenize',
        },
        {
          type: 'doc',
          id: 'sdk/android/functions/clear_fields',
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'doc',
          id: 'sdk/android/ui_components/pay_theory_button',
        },
        {
          type: 'doc',
          id: 'sdk/android/ui_components/pay_theory_barcode',
        },
        {
          type: 'doc',
    ...
    },
    {
      ...
      items: [
        {
          type: 'doc',
          id: 'sdk/android/response_types/successful_transaction_result',
        },
        {
          type: 'doc',
          id: 'sdk/android/response_types/failed_transaction_result',
        },
        {
          type: 'doc',
          id: 'sdk/android/response_types/payment_method_token_results',
        },
        {
          type: 'doc',
          id: 'sdk/android/response_types/barcode_result',
        },
        {
          type: 'doc',
          id: 'sdk/android/response_types/pt_error',
        },
      ],
    },
    {
      ...
      items: [
        {
          type: 'doc',
          id: 'sdk/android/data_models/configuration',
        },
        {
          type: 'doc',
          id: 'sdk/android/data_models/address',
        },
        {
          type: 'doc',
          id: 'sdk/android/data_models/payor',
        },
        {
          type: 'doc',
  ...
  javascriptSidebar: [
    ...
    {
      type: 'doc',
      id: 'sdk/javascript/event_listeners',
    },
    {
      type: 'doc',
      id: 'sdk/javascript/payment_button',
    },
    {
      type: 'doc',
      id: 'sdk/javascript/payment_qr_code',
    },
    {
      type: 'doc',
      id: 'sdk/javascript/errors',
    },
    {
      type: 'doc',
