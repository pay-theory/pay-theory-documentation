...
Input for digital wallet.

| Field | Type | Description |
| --- | --- | --- |
| `address_line1` | `String` | Address line 1. |
| `dpan` | `String!` | No description available. |
| `exp_date` | `String!` | Date for exp. |
| `postal_code` | `String` | Postal code. |
| `wallet_type` | `WalletType!` | The wallet type. See type definition: WalletType. |
