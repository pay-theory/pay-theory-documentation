...
| --- | --- | --- |
| `items` | `[Dispute]` | List of Disputes. See type definition: Dispute. |
...
| `status` | `DisputeStatus` | The status of the dispute. See type definition: DisputeStatus. |
| `reason` | `DisputeReason` | The reason code for the dispute as passed by the card issuer. See type definition: DisputeReason. |
...
| `transaction` | `Transaction` | The transaction object for the transaction that is in dispute. More information on the transaction object can be found here. See type definition: Transaction. |
