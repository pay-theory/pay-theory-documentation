...
export const initialCardState: Partial<
  Record<ElementTypes, typeof initialState>
> = {
...
export const initialAchState: Partial<
  Record<ElementTypes, typeof initialState>
> = {
...
export const initialCashState: Partial<
  Record<ElementTypes, typeof initialState>
> = {
...
export const CARD_BILLING_LINE1 =
  'pay-theory-credit-card-billing-line1-tag-frame';
export const CARD_BILLING_LINE2 =
  'pay-theory-credit-card-billing-line2-tag-frame';
export const CARD_BILLING_CITY =
  'pay-theory-credit-card-billing-city-tag-frame';
export const CARD_BILLING_STATE =
  'pay-theory-credit-card-billing-state-tag-frame';
...
export const transactingWebComponentMap: Record<
  TransactingType,
  {
    ...
    defaultState:
      | typeof initialCardState
      | typeof initialAchState
      | typeof initialCashState;
  }
> = {
  ach: {
