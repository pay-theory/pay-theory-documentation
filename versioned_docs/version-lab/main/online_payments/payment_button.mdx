...
| checkoutDetails         |object             |The details for the checkout page that opens when the button is clicked. Details are mentioned [above](#3-prepare-the-checkout-details).|
