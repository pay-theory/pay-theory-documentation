...
If you are calling the [createTransaction](/docs/lab/api/transaction/create-transaction) endpoint you will receive a response and the `failure_code` will be the `failure_reason` in the response.
