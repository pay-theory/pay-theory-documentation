...
Instead of immediately processing a payment with [`transact`](/docs/sdk/apple/functions/transact.mdx), you can [tokenize](/docs/sdk/apple/functions/tokenize_payment_method.mdx) a payment method for later use.
:::
...
* [Styling and Managing States](./styling_pay_theory_fields)
