...
```
:::note Additional errorObserver functionality
View more details on errorObserver functionality

<a href= "../../sdk/javascript/EVENT_LISTENERS#error-observer" class="button button--primary button--md">View ErrorObserver</a>
:::
