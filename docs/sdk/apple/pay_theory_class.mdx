...
These variables provide access to the current state of different payment methods (card, cash, and ACH). Each state object contains validation status and entered details for the respective payment method.
