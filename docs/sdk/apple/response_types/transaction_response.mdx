...
| Property | Type | Description |
|----------|------|-------------|
| transactionId | String | The unique transaction_id assigned to a transaction by Pay Theory. |
...
| failureCode | String | The failure code for the failure. See [Failure Codes](/docs/main/after_payments/failed_transactions) for a complete list. |
